...
def pokemon_creator():
  ...
  while True:
    ...
    check = input(f'Are you happy with {name.title()} as your new pokemon? [Y/N]\n')
  ...
  if  user_rand == 1: 
    print(tabulate([stat_max],headers= stat_headers, tablefmt='fancy_grid'))
  #elif user_rand == 2:
